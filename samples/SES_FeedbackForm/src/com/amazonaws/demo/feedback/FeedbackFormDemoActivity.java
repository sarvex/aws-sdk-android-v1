...
public class FeedbackFormDemoActivity extends Activity {
    ...
    protected void sendFeedback() {
    	...
    	if (commentsField.getText().length() == 0 || nameField.getText().length() == 0) {
    	...
    	else if (SESManager.sendFeedbackEmail(commentsField.getText().toString(), nameField.getText().toString(), ratingBar.getRating())) {
