 ...
 * 
 * <ul>
 * <li> <a href="http://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_Operations.html"> Actions </a> : An alphabetical list of all Amazon
 * CloudWatch actions.</li>
 * <li> <a href="http://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_Types.html"> Data Types </a> : An alphabetical list of all Amazon
 * CloudWatch data types.</li>
 * <li> <a href="http://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/CommonParameters.html"> Common Parameters </a> : Parameters that all
 * Query actions can use.</li>
 * <li> <a href="http://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/CommonErrors.html"> Common Errors </a> : Client and server errors that
 * all actions can return.</li>
 ...
 * </ul>
 * <p>
 * In addition to using the Amazon CloudWatch API, you can also use the following SDKs and third-party libraries to access Amazon CloudWatch
 * programmatically.
 * </p>
 * 
 * <ul>
...
public class AmazonCloudWatchAsyncClient extends AmazonCloudWatchClient
     ...
     * </p>
     * <p>
     * Each <code>PutMetricData</code> request is limited to 8 KB in size
     * for HTTP GET requests and is limited to 40 KB in size for HTTP POST
     * requests.
     * </p>
     * <p>
     * <b>IMPORTANT:</b>Although the Value parameter accepts numbers of type
     * Double, Amazon CloudWatch rejects values that are either too small or
     ...
     * CloudWatch, go to <a
     * n.com/AmazonCloudWatch/latest/DeveloperGuide/CW_Support_For_AWS.html">
     * Amazon CloudWatch Metrics, Namespaces, and Dimensions Reference </a>
