...
public class S3Link {
    ...
    public S3Link(S3ClientCache s3cc, String bucketName, String key) {
        this(s3cc, new ID(bucketName, key));
    }

    public S3Link(S3ClientCache s3cc, Region region, String bucketName, String key) {
    ...
    public static class ID {
        ...
        public ID() {} // used by Jackson to unmarshall
        public ID(String bucketName, String key) {
            this.s3 = new S3(bucketName, key);
        }
        public ID(Region region, String bucketName, String key) {
